...
- Recherche rapide à facettes.
- Multilingue (français, anglais, arabe).
- Conformité à l'accessibilité WCAG 2.1 niveau AA.
- Export CSV ou Excel depuis l'administration.
- Carrousel d'accueil éditable par les administrateurs.

### Could have — nice to have

- Chatbot conversationnel pour le support de premier niveau.
...
## Interface utilisateur — Tailwind CSS et shadcn/ui
...
La base de données est structurée autour de **six grands domaines**, eux-mêmes composés d'entités reliées entre elles :
...
- **Relation client** : les messages issus du formulaire de contact et du chatbot.
